...
const vestingContractAbi = require("../contract_info/vesting_contract_skypublic_abi.json");
const swprContractAbi = require("../contract_info/skbr_contract_abi.json");
...
export function useGetSchedulePlain(index) {
  const [percentage, unlockTime, isSent] =
    useContractCall({
      abi: vestingContractInterface,
      address: vestingContractAddress,
...
export function useGetUserSchedulePlain(account, index) {
  const [amount, claimedAmount, unlockTime, isFixed] =
    useContractCall({
      abi: vestingContractInterface,
      address: vestingContractAddress,
      method: "schedules",
