...
import tokenLogo from '../../assets/img/Skybridge_Logo.png';
import MyModal from '../modal/Modal';
import BuyModalNew from '../modal/BuyModalSkypublic';
                        ...
                        <section className="mt-auto">
                            <div className="toekn-detail-header d-flex mt-5">
                                ...
                                <div className="custom-card-title">
                                    <h2 className="text-white mb-auto  tokenLogoTitle">Skybridger
</h2>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-white">
                                        ...
                                        {(whitelistOfTiers[toCheckAddress(account)] > 0 && currentTime <= saleEndTime && currentTime >= saleStartTime) && (
                                            <button className="btn btn-wallet wallet-connected mr-4 mb-2" onClick={ () => handleBuyToken(true) }> <BiMoney /> Buy SKBR (WhiteList) </button>
                                        ...
                                        {/* {(whitelistOfTiers[toCheckAddress(account)] && currentTime >= startFcfsTime && currentTime <= saleEndTime && currentTime >= saleStartTime) && (
                                            <button className="btn btn-wallet wallet-connected mx-auto mb-2" onClick={ () => handleBuyToken(false) }> <BiMoney /> Buy SKBR ( FCFS ) </button>
                    ...
                    <Col sm={7}>
                        <section className="custom-card-detail text-white">
                            ...
                            <div className="grid-box text-white">
                                <div style={{paddingRight: '3rem'}}> {!swprBalance ? ('-') : (swprBalance + ' SKBR')} </div>
                                ...
                                {whitelistOfTiers[toCheckAddress(account)] && (
                                    <div> { Number(tier * 100).toFixed(2) + ' SKBR'} </div>
                                )}
                            </div>
                            ...
                            <div className="grid-box text-white">
                                <div> {lockedTokenAmount + ' SKBR'} </div>
                                <div> {remainSWPRAmount - 2129000 + ' SKBR'} </div>
                            </div>
                            <div className="grid-box text-white">
                            ...
                            <div className="custom-card-footer detail-bar">
                                <div className="custom-progress-bar">
                                    ...
                                    <div className="progress-title">
                                        ...
                                        <span style={{ color: 'white', fontWeight: 'bold' }}>{soldAmount + '/50000000.00000' }</span>
                                    </div>
                                </div>
                            </div>
                        </section>
