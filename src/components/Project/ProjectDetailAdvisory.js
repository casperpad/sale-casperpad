...
import { schedulePlain, preSaleAmount } from '../../contract_info/vestingDataAdvisory';

export default function ProjectDetailAdvisory() {
    ...
    scheduleAmount.push(amount13);
    scheduleAmount.push(amount14);
    scheduleAmount.push(amount15);
    scheduleAmount.push(amount16);
    scheduleAmount.push(amount17);
    scheduleAmount.push(amount18);
    scheduleAmount.push(amount19);
    scheduleAmount.push(amount20);
    scheduleAmount.push(amount21);
    scheduleAmount.push(amount22);
    scheduleAmount.push(amount23);
    scheduleAmount.push(amount24);
                            ...
                            <div className>
                                <Table responsive="sm" className="text-white">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Opens</td>
                                            <td>{'2022-03-11 00:00 UTC'}</td>
                                        </tr>
                                        <tr>
                                            <td>Token Price</td>
                                            <td>{'1 SWPR = 0.008 USD'}</td>
                                        </tr>
                                        <tr>
                                            <td>Cap</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>{'$ ' + Number(limitPresaleAmount * 0.008).toFixed(2)}</td>
                                        </tr>
                                    </tbody>
                                </Table>
                            </div>
