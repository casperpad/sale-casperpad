...
export default function TokenDetail() {
    ...
    useEffect( () => {
        ...
        setLockedUSDAmount(Number(lockedTokenAmount * 0.009).toFixed(5));
        ...
        setTier(maxAmountOfTier ? Number((maxAmountOfTier*0.009)).toFixed(5) : 0);
                    ...
                    <Col sm={7}>
                        <section className="custom-card-detail text-white">
                            ...
                            <div className="grid-box text-white">
                                ...
                                <div> { Number(tier / 0.009).toFixed(2) + ' SWPR'} </div>
                            </div>
