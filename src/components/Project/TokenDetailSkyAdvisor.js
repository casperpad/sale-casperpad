...
import BuyModal from '../modal/BuyModalSkyAdvisor';
...
export default function TokenDetail() {
    ...
    return (
        <>
                        ...
                        <section className="mt-auto">
                            <div className="toekn-detail-header d-flex mt-5">
                                ...
                                <div className="custom-card-title">
                                    <h2 className="text-white mb-auto  tokenLogoTitle">Skybridger</h2>
                                </div>
                            </div>
                            <div className="custom-card-header">
                                <div>
                                    ...
                                    <div className="text-white">
                                        ...
                                        { ( whitelistOfTiers[toChecksumAddress(account)] && amount0 == 0 && currentTime >= saleStartTime  && currentTime <= saleEndTime) && (
                    ...
                    <Col sm={7}>
                        <section className="custom-card-detail text-white">
                            ...
                            <div className="grid-box text-white">
                                ...
                                <div> { Number(tier / 0.01).toFixed(2) + ' SKBR'} </div>
                            </div>
            ...
            <BuyModal isOpenBuy = { isOpenBuy } setIsOpenBuy = {setIsOpenBuy} onlyOneToast = {false}/>
        </>
    );
}